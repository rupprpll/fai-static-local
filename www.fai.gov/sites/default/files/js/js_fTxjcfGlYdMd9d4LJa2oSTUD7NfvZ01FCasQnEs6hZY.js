...
(function($, Drupal) {
  ...
  Drupal.behaviors.toggleMenuMobile = {
    attach: function(context, settings) {
      $('main', context).once('toggleMenuMobile').each(function () {
  ...
  Drupal.behaviors.growSvgs = {
    attach: function(context, settings) {
      $('main', context).once('growSvgs').each(function () { // aria-controls=basic-nav-section-4
  ...
  Drupal.behaviors.setPdfAnchorsToolkit = {
    attach: function(context, settings) {
      $('a[class="fai-tool-kit-titles"]').once('setPdfAnchorsToolkit').each(function(index, el) {
        if(el.href.indexOf(".pdf") > 0) {
          el.innerHTML = '<img src="/'+ drupalSettings.path.themeUrl +'/img/pdf.svg" width="16" height="18" alt="'+ el.innerHTML +'" class="fai-tool-kit-title-imgs"/>'+ el.innerHTML;
        }
      });
    }
  };
  ...
  Drupal.behaviors.setJqueryBackToTop = {
    attach: function(context, settings) {
      $('main', context).once('setJqueryBackToTop').each(function () {
        var offset = 220;
        var duration = 500;
  ...
  /* Drupal.behaviors.addBlueBarToMainMenu = {
    attach: function(context, settings) {
      $('main', context).once('addBlueBarToTools').each(function () { // aria-controls=basic-nav-section-4
        $('button.usa-accordion__button.usa-nav__link').click(function(evt) {
          evt.preventDefault();
          if ($(this).attr('aria-expanded') === "true") $(this).attr("aria-expanded", false);
          else $(this).attr("aria-expanded", true);
...
(function($) {
  ...
  function init() {
      if (!initialized) {
          ...
          $("div.views-field-field-news-image").each(function() {
  ...
  function addsidenav_attribute(){
    ...
    $('.usa-sidenav__sublist').attr("role", "subtablist");
  }
  ...
  Drupal.behaviors.betterExposedFiltersAutoSubmit = {
    attach: function(context) {
      $(document).once('viewFormUpdate').ajaxComplete(function(event, xhr, settings) {
  ...
  Drupal.behaviors.submitAutomationsForm = {
    attach: function(context) {
      $('#edit-submit-periodic-table-automation').once().on('click', function () {
  ...
  Drupal.behaviors.closeMenusOntab = {
      attach: function(context) {
          $(document).once('closeMenusOntab').keydown(function(e) {
  ...
  Drupal.behaviors.fai = {
      attach: function(context, settings) {
          $('body', context).once('fai').each(function() {
...
;
(function ($) {
  Drupal.behaviors.FAIPeriodicTableBeta = {
    attach: function () {
      // Apply only for the .btn_automation
      $(".fai-periodic-table-navigation-buttons .btn_automation").one("click", function () {
        $(this).append('<span class="beta-text" style="color:#AD0000;font-weight:bold;vertical-align:90%;">BETA</span>');
      });

      // This selector if not contains BETA, then append.
      $(".usa-media-block > div:nth-child(2):not(:contains('BETA'))").append('<span class="beta-text" style="color:white;font-weight:bold;vertical-align:top;">BETA</span>');
      // This selector if 'Periodic Table Search' display appended element in line.
      $(".usa-media-block > div:nth-child(2) > h1:nth-child(1):contains('Periodic Table Search')").css({'display':'inline','vertical-align':'top'});
      // Only append to H1 that has 'Periodic Table Search', remove from the rest that has same selectors.
      $(".usa-media-block > div:nth-child(2):not(:contains('Periodic Table Search'))").children().last().remove();

      $("div.form-item.form-item-search-api-fulltext > label:nth-child(1):not(:contains('BETA'))").append('&nbsp<span class="beta-text" style="color:#AD0000;font-weight:bold;vertical-align:super;">BETA</span>');
      $("div.form-item.form-item-search-api-fulltext > label:nth-child(1):not(:contains('Fulltext search'))").children().last().remove();
    }
  };
})(jQuery);
;
